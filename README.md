...
|Instruction | Opcode | ALUop |0: Use source from Register File 1: Use Sign Extended Value| ---- | SE_Sel | memWrite | memRead | regWrite | memToReg | WriteR15 | ChangePC | Comparator|
|----|------|------|---|---|----|----|----|----|---|---|---|----|
